...
const Docs = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="flex">
        {/* Sidebar — keeps navy dark background */}
        <aside className="hidden lg:block w-64 border-r border-border fixed left-0 top-0 h-screen bg-navy-deep">
          <div className="p-6">
            <Link to="/">
          ...
          <div className="container mx-auto px-4 py-16 max-w-4xl">
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                <ol className="space-y-4">
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="text-foreground">Create a free account at <Link to="/auth" className="text-accent hover:underline font-medium">ScopeSG</Link></p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    ...
                    <div>
                      <p className="text-foreground">Navigate to the <Link to="/chat" className="text-accent hover:underline font-medium">AI Analyst</Link> chat to begin your consultation</p>
                    </div>
                  </li>
                </ol>
              </div>
            ...
            <section id="ai-analyst" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">AI Analyst Chat</h2>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
            ...
            <section id="premium-report" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">Premium Business Report</h2>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm space-y-6">
                ...
                <div className="border-t border-border pt-6">
                  ...
                  <ol className="space-y-3">
                    ...
                    <li className="flex gap-3 text-muted-foreground">
                      ...
                      <span>Click the <strong className="text-foreground">'Generate Premium Report'</strong> button</span>
                    </li>
                    <li className="flex gap-3 text-muted-foreground">
                ...
                <div className="border-t border-border pt-6">
                  ...
                  <ol className="space-y-3">
                    <li className="flex gap-3 text-muted-foreground">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">1</span>
                      <span>On your report page, click <strong className="text-foreground">'Download PDF'</strong></span>
                    </li>
                    <li className="flex gap-3 text-muted-foreground">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">2</span>
                    ...
                    <li className="flex gap-3 text-muted-foreground">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">3</span>
                      <span>Select <strong className="text-foreground">'Save as PDF'</strong> to save to your device</span>
                    </li>
                  </ol>
                </div>
              </div>
            ...
            <section id="enhance-report" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">Enhance Your Report</h2>
                <span className="ml-auto text-emerald-600 text-sm font-medium px-2 py-1 bg-emerald-50 border border-emerald-200 rounded-full">Free</span>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                <p className="text-muted-foreground mb-4">
                  After receiving your report, click <strong className="text-foreground">'Enhance This Report'</strong> to add more business details and regenerate a more comprehensive version at no extra cost.
                </p>
                <h3 className="font-semibold text-foreground mb-3">Steps</h3>
                <ol className="space-y-3">
                  <li className="flex gap-3 text-muted-foreground">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">1</span>
                    <span>Open your report from <Link to="/my-reports" className="text-accent hover:underline font-medium">My Reports</Link></span>
                  </li>
                  <li className="flex gap-3 text-muted-foreground">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">2</span>
                    <span>Click <strong className="text-foreground">'Enhance This Report'</strong></span>
                  </li>
                  <li className="flex gap-3 text-muted-foreground">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">3</span>
                  ...
                  <li className="flex gap-3 text-muted-foreground">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center text-xs font-semibold">4</span>
                    <span>Click <strong className="text-foreground">'Generate Enhanced Report'</strong> — takes 1-2 minutes</span>
                  </li>
                </ol>
              </div>
            </section>
            ...
            <section id="my-reports" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">My Reports</h2>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                <p className="text-muted-foreground">
                  Access all purchased reports anytime from the <strong className="text-foreground">profile dropdown menu</strong> in the top navigation. Reports are saved permanently to your account.
                </p>
              </div>
            </section>
            ...
            <section id="market-trends" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">Market Trends</h2>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                <p className="text-muted-foreground mb-4">
            ...
            <section id="market-news" className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-display text-2xl font-semibold text-foreground">Market News</h2>
              </div>
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                <p className="text-muted-foreground mb-4">
                  Curated Singapore and global news with <strong className="text-foreground">AI-predicted market impact</strong>.
                </p>
                <h3 className="font-semibold text-foreground mb-3">Each item includes:</h3>
                <ul className="grid md:grid-cols-2 gap-3">
                  {[
                    "Severity rating",
                    "Affected sectors",
            ...
            <section id="faq" className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    Reports are <strong className="text-foreground">non-refundable once generated</strong> as AI processing costs are incurred immediately.
                  </p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    Reports use <strong className="text-foreground">Claude Sonnet</strong> with real-time web search for current Singapore market data. Always verify with a professional before making business decisions.
                  </p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    Typically <strong className="text-foreground">1-3 minutes</strong>. Do not close the tab while generating.
                  </p>
                </div>
              </div>
            </section>
