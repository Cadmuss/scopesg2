...
serve(async (req) => {
  ...
  try {
    ...
    const origin = req.headers.get("origin") || Deno.env.get("APP_BASE_URL") || "https://bd880c29.local-credentialless.webcontainer.io";
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${origin}/report-success?order_id=${reportRow.id}`,
